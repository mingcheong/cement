...
<div class="lm1">
	<table width="100%" border="0"  cellpadding="0" cellspacing="0" style="border:2px #9C0 dashed; background-color: #f4f4f4">
     <tr>
    <td class="table_list" ><b><font color="#FFFFFF" face="微软雅黑" size="+1">师生问答</font></b></td>
  ...
  <?php }?>
  <tr><td></td><td align="right"><a href="<?php echo site_url('html/ask/askList/'.$ssrow['cid']);?>"><b><font color="#99CC00" face="微软雅黑" size="+1">更多</font></a></td></tr>
</table>

	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top:20px; border:#9C0 2px dashed;background-color: #f4f4f4"">
     <tr>
    <td class="table_list" ><b><font color="#FFFFFF" face="微软雅黑" size="+1">学生交流</font></b></td>
    <td class="table_list"><span class="wlm2"  ><b><font color="#FFFFFF" face="微软雅黑" size="+1">我来提问</font></b></span><div style="position:absolute; background-color: #99CC66;z-index:100; width:193px; height:120px; display:none " id="tm2"><form action="<?php echo site_url('html/ask/add');?>" method="post"> <textarea cols="25" rows="6" name="content"  ></textarea><input type="hidden" value="0" name="p_id" /><input type="hidden" value="0" name="type" /><input type="hidden" name="cid" value="146" /><input type="submit" value="提交" /></form></div></td>
     </tr>
   <?php foreach($xs_list as $ssrow){?>
  <tr  >
    <td width="77%" class="tdc" >
    <div style="border-bottom:solid 1px #CCCC99;">&nbsp;&nbsp;
    <a href="javascript:void(0);" class="wt" id="wt_<?php echo $ssrow['id'];?>" ><?php echo $ssrow['content']?></a>
  ...
  <?php }?>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:2px #9C0 dashed; margin-top:20px;background-color: #f4f4f4">
     <tr>
    <td class="table_list"><b><font color="#FFFFFF" face="微软雅黑" size="+1">作业提交</font></b></td>
    <td class="table_list">&nbsp;</td>
     </tr>
  <?php foreach($zy_list as $ssrow){?>
  <tr >
    <td width="77%" class="tdc" ><div style="color:#848484;">&nbsp;&nbsp;<?php echo $ssrow['content']?></div>
      <div style="display:none" id="<?php echo $ssrow['id'];?>_ext" >
    <?php echo form_open_multipart('html/work/add');?>
   <input type="file" name="userfile"  />
    <input type="hidden" value="1" name="type" /><input type="hidden" name="cid" value="147" />
    <input type="hidden" name="p_id" value="<?php echo $ssrow['id'];?>" />
     <input type="submit" value="提交" />
    </form>
    ...
    <td width="23%" valign="top"  class="tdc"><font color="#999999"><?php echo $ssrow['add_date']?></font>&nbsp; <span class="gb" id="gb_<?php echo $ssrow['id']?>">我要提交</span></td>
  </tr>
  <?php }?>
