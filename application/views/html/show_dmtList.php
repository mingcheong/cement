          ...
          <td width="718" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
			  ...
			  <div class="new_2" id="div">
					<?php foreach ($getArticleList as $cate){?>
						<div class="list">
						  <div class="list_content"><a href="<?php echo site_url('html/show/dmt_content/'.$cid.'/'.$cate['id']);?>" target="_blank"><?php echo $cate['title']?></a></div>
						</div>
					<?php }?>				  		  
              </div>
			  </div></td>
