                ...
                <td colspan="2" height="44">
                  ...
                  <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
					<?php foreach ($list as $art){?>
						<tr> 
						  <td class="tdd" width="84%" height="27" valign="middle"><img src="images/html/W020110725469023291409.gif" width="9" height="9"> 
							<a href="<?php echo @$art['db0'];?>" target="_blank"><?php echo $art['title']?></a> <?php if (isset($art['pic'])){?><img src="images/html/ico_camera.jpg" width="15" height="11"><?php }?></td>
