                      ...
                      <td width="38%" style="text-align:center"> 
						<table width="100%" border="0" cellspacing="0" cellpadding="0" height="15">
							<tr><td style="padding-left:20px;">
								<a href="<?php echo site_url('html/show/details/'.$art['id'].'/'.$art['cid']);?>" target="_blank"><img alt="example1" class="imgpic" src="<?php echo @$art['pic']?>" width="200" height="198"/></a>
                          </td></tr>
							<tr>
                          <td class="tdd" height="32" style="text-align:center">
							<img src="images/html/arrowbule.jpg" width="11" height="9">
							<a href="<?php echo site_url('html/show/details/'.$art['id'].'/'.$art['cid']);?>" target="_blank"><?php echo @$art['title']?></a></td></tr>
						</table>
                      </td>					  
					<?php if (($index%3+1)==3){?>
					</tr>			
