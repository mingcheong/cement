                ...
                <td width="705" height="73" valign="top"> 
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="15">
					...
					<?php }?>					
                      ...
                      <table width="29%" border="0" cellspacing="0" cellpadding="0" height="15">
                        <tr>
                          <td height="172"> <a class="example2" href="<?php echo empty($art['oripic']) ? 'images/admin/nopic.jpg' : $art['oripic']?>" title="<?php echo @$art['title']?>"><img alt="example1" class="imgpic" src="<?php echo @$art['pic']?>" width="200" height="198"/></a> 
                          </td>
                        </tr>
							<tr>
